...
def show_lose():
    ...
    lose_win.setText("лох")
    lose_win.exec_()

app = QApplication([])
main_win = QWidget()
main_win.setWindowTitle("idk")
main_win.resize(400, 200)

question = QLabel("в якому році була заснована Logika?")
winner = QLabel("?")
...
#layout_main.addWidget(winner, alignment = Qt.AlignCenter)
